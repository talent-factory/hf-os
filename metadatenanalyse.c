...
int main() {
    ...
    // Weiteren Text zur Datei hinzufügen
    fprintf(file, "Dies ist ein zusätzlicher Text, der angehängt wurde.\n");
    fprintf(file, "Diese Änderung sollte die Dateigröße und Änderungszeit aktualisieren.\n");
    ...
    // Hardlink zur Originaldatei erstellen
